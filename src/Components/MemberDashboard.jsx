                                ...
                                <div className="card mb-3" style={{ borderRadius: '1rem' }}>
                                    <div className="row g-0">
                                        <div className="col-md-5 text-center text-white pb-4" style={{ borderTopLeftRadius: '.5rem', borderBottomLeftRadius: '.5rem', backgroundColor: "#E31C25" }}>
                                            <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava4-bg.webp" alt="Avatar" className="img-fluid my-5" style={{ width: 80 }} />
                                                            ...
                                                            <>
                                                                <div className="row pt-1">
                                                                    <div className="col-6 mb-3">
                                                                        ...
                                                                        <p className="text-white"><b>{item?.serviceId?.data?.service_name}</b></p>
                                                                    </div>
                                                                    <div className="col-6 mb-3">
