...
import { AddBlogDetailsData } from '../Redux/BlogDetailsSlice';
...
const BlogDetails = () => {
    ...
    useEffect(() => {
        dispatch(AddBlogDetailsData(_id));
    }, [dispatch]);
            ...
            <Layout>
                <div className="container-fluid page-header mb-5">
                    <div className="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style={{ minHeight: '400px' }}>
                        <h4 className="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Blog Detail Page</h4>
                ...
                <div className="container py-5">
                    <div className="row">
                        <div className="col-12">
                            <img className="img-fluid mb-4" src={`https://corefitserver.onrender.com/${blogdetails_data?.data?.data?.image}`} alt="Image" />
