        ...
        <>
            <Layout>
                ...
                <div className="container pt-5">
                    ...
                    <div className="row">
                        {
                            blog_data?.data?.slice(0,7).slice(0, visible).map((item, key) => {
                                return (
                                    <>
                                        <div className="col-lg-6 mb-5 blog-item">
                                            ...
                                            <p className="font-weight-bold" style={{ minHeight: '70px' }}>{item?.content.slice(0, 80)}{`...`}</p>
                                            <Link to={`/blogDetails/${item._id}`} className="btn btn-outline-primary mt-2 px-3">Read More <i className="fa fa-angle-right"></i></Link>
                                        </div>
                                    </>
                                )
                            })}
